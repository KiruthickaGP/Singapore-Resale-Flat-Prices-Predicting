...
icon = Image.open("E:\Guvi_Data_science\Projects\Singapore_Price_Analysis\Singaporepriceanalysis.jpg")
# Set page configurations with background color
st.set_page_config(
    page_title="Singapore  Resale Flat Prices Predicting  | By Kiruthicka",
    page_icon=icon,
    layout="wide",
...
<style>
    body {
        background-color: #FFFFFF;  /* Set background color to #F7EBED*/            #AntiqueWhite color
    }
    .stApp {
...
logo = Image.open("E:\Guvi_Data_science\Projects\Singapore_Price_Analysis\Singaporepriceanalysis.jpg")
...
if selected == "Home":
    ...
    with col1:
        image = Image.open("E:\Guvi_Data_science\Projects\Singapore_Price_Analysis\Singaporepriceanalysis.jpg")
        st.image(image, width=500,  output_format='JPG', use_column_width=False)
    ...
    with col2:
        ...
        st.markdown("#### Pandas, NumPy: Libraries for data manipulation and numerical operations")
...
if selected == "Predictive analysis":
    ...
    def load_data():
        # Load data
        data = pd.read_csv(r"E:\Guvi_Data_science\Projects\Singapore_Price_Analysis\singapore.csv")
